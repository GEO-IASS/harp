...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    // if (strcmp(funcname, "APPEND") == 0)
    // {
    //     harp_matlab_append(nlhs, plhs, nrhs - 1, &(prhs[1]));
    // }
    // else if (strcmp(funcname, "CLEARALL") == 0)
    // {
    //     harp_matlab_clearall(nlhs, plhs, nrhs - 1, &(prhs[1]));
    // }
    // else if (strcmp(funcname, "EXPORT") == 0)
    // {
    //     harp_matlab_export(nlhs, plhs, nrhs - 1, &(prhs[1]));
    // }
    // else if (strcmp(funcname, "FIND_COLOCATED_DATA") == 0)
    // {
    //     harp_matlab_find_colocated_data(nlhs, plhs, nrhs - 1, &(prhs[1]));
    // }
    ...
    // }
    // else if (strcmp(funcname, "SLICE") == 0)
    // {
    //     harp_matlab_slice(nlhs, plhs, nrhs - 1, &(prhs[1]));
    // }
...
//         buflen = mxGetN(prhs[1]) + 1;
//         filter = (char *)mxCalloc(buflen, sizeof(char));
//         if (mxGetString(prhs[1], filter, buflen) != 0)
//         {
//             mexErrMsgTxt("Unable to copy filter string.");
//         }
//     }

//     if (harp_ingest(num_files, (const char **)filenames, filter, &product) != 0)
//     {
//         harp_matlab_harp_error();
//     }
